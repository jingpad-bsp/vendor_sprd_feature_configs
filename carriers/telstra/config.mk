...
#    vendor/sprd/feature_configs/telstra/overlay
...
FEATURES.PRODUCT_PACKAGES += \
    SprdDialer_telstra_rro \
    TeleService_telstra_rro \
    framework-res_telstra_rro \
    Settings_telstra_rro \
    SystemUI_telstra_rro

FEATURES.PRODUCT_PRODUCT_PROPERTIES += \
    ro.carrier=telstra

FEATURES.PRODUCT_PACKAGES += \
    DialerTelstraOverlays
